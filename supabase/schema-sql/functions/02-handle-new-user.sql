...
-- Description: Creates profile and role on user signup
-- Called by trigger on auth.users
-- ============================================
...
COMMENT ON FUNCTION public.handle_new_user IS 'Creates profile and role on signup. Has exception handler to prevent auth failures.';
